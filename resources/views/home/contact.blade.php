                    ...
                    <form class="comments-form contact-form" action="">
                       ...
                       <div class="col-md-6">
                         <div class="form-group"> 
                          <label for="email">Email:</label>                       
                           ...
                           <input type="email" placeholder="if you want.." class="form-control">
                         </div>
                       </div>
                     </div>
                      <div class="row">
                       <div class="col-md-6">
                         <div class="form-group"> 
                          <label for="email">Subject:</label>                       
                           ...
                           <input type="text" placeholder="your enquiry about?" class="form-control">
                         </div>
                       </div>
                       <div class="col-md-6">
                         <div class="form-group">
                     ...
                     <div class="form-group"> 
                      <label for="email">Your message:</label>                       
                       ...
                       <textarea class="form-control" rows="3" placeholder="write what you want us to do..."></textarea>
                     </div>
