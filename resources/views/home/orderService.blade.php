...
<br>
      ...
      <input type="submit" class="btn btn-primary" value="{{__('customlang.order')}}">
        ...
        <div class="col-md-5">
          ...
          <div class="form-group">
            <img style="width:90%;height:250px" src="{{ URL::asset('uploads/services/'.$category->cover_image)}}">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="men">
                  <ul class="aa-product-catg">
                    ...
                    <li>
                      <figure>
                        <a class="aa-product-img" href="/view-services/{{$service->id}}"><img src="{{ URL::asset('uploads/services/'.$category->cover_image)}}" style="width: 100%; height: 250px" alt="polo shirt img" ></a>
